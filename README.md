# [DEPRECATED] Greenhouse Source dbt Package

> _This package has been archived and is no longer maintained. Use [`dbt_greenhouse`](https://github.com/fivetran/dbt_greenhouse) instead, which now contains all models previously found here._
